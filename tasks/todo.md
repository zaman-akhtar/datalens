...
- [x] **T001 — Verify starter scaffolding builds**
...
- [x] **T002 — Push starter to GitHub, confirm agent commits**
...
- [x] **T010 — POST /api/upload endpoint**
...
- [x] **T011 — SQLite ingestion service**
...
- [x] **T013 — GET /api/datasets/{id}/profile**
...
- [x] **T014 — Frontend upload dropzone + dataset hook**
...
- [x] **T021 — POST /api/datasets/{id}/query endpoint + safe builder**
...
- [x] **T022 — Five chart components (Recharts)**
...
- [x] **T024 — Loading / error / empty states**
...
- [x] **T030 — useFilters Zustand store**
...
- [x] **T032 — Query engine accepts filters**
...
- [x] **T040 — Gemini provider wrapper**
...
- [x] **T042 — POST /api/datasets/{id}/chat**
...
- [x] **T044 — Persist chat history per dataset**
...
- [x] **T051 — GET /api/datasets/{id}/summary**
...
- [x] **T052 — ExecutiveSummary component**
...
- [x] **T053 — Playwright assertion: ≥ 3 numeric facts**
...
- [x] **T062 — Cross-dataset Playwright test**
...
- [x] **T063 — Final report (`docs/report.md`)**
